...
img: assets/img/man-vs-robotorange.svg
importance: 1
...
toc:
  - name: Realising the Future of Dexterous Robotics with Flexible Electrohydraulic Artificial Muscles
  - name: Summary
  - name: Objectives
...
The project team is led by [Artimus Robotics](https://www.artimusrobotics.com/) (Dr Nicholas Kellaris) and University of Bristol (Dr Efi Psomopoulou). The award is funded by the [Advanced Research + Invention Agency (ARIA)](https://www.aria.org.uk/) as part of the [Robot Dexterity programme](https://www.aria.org.uk/opportunity-spaces/smarter-robot-bodies/robot-dexterity/meet-the-creators) (Technical Area 1: Novel Hardware).

<div class="row justify-content-sm-center">
    <div class="col-md-12">
        {% include figure.liquid path="assets/img/ARIAProjectlogos.png" title="funded by ARIA" class="rounded z-depth-1" %}
    </div>
</div>
